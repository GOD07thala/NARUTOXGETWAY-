...
<div class="container">
        ...
        <br/>        
<br />
<h2>1.<a href="https://t.me/useridinfobot">Click Here</a> U are Going Telegram Bot And Click/Start
<br>
<br>
2.After/start U Get Telegram Id,Copy & Paste Input Place And Submit
<br>
<br>
3.Done! U Will Receive Campaign alert In <a href="https://t.me/SwatleadBot">@SwatLeadBot</a></h1>
         <br />
<input class="input inp" type="text"placeholder="Telegram Id" name="tg">                
...
$json1='{"tg":"'.$tg.'"}';
file_put_contents(''.$session.'/gatew00/tele.json',$json1);

echo '<script>alert("Bot Alert Added Successfully")</script>';
echo"<meta http-equiv='refresh' content='0;url=botalert.php'>";   
}}
?>