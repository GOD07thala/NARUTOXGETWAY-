...
echo"<br><br><br><br><center><input type='text' class='input inp' value='https://SwatCampaign.xyz/instant/?token=$session&s1={sub_aff_id}&s2={aff_click_id}&s3={offerid}&s4={event_name}' readonly='readonly' id='myInput'> <input type='submit' value='Copy Postback' onclick='myFunction()'></center>";
}
?>
<script>
function myFunction() {
